   ...
   <div class="index_box"  >
      <div class="nav_left" id="index_box" style="">
         ...
         <ul>
            ...
            <li><i class='fa-solid fa-book' id="an_right"></i><a href="new_patient.php" target="iframe" onclick="hideMenu()">New patient</a></li>
         <li><i class='fa-solid fa-book' id="an_right"></i><a href="patient.php" target="iframe" onclick="hideMenu()">Patient Info</a></li>
            <li><i class='fa-solid fa-list' id="an_right"></i><a onclick="g()" style="color: white;">Drug<i class='fa-solid fa-angle-down' id="an_rightt"></i><i class='fa-solid fa-angle-up' id="an_down"></i></a>
            <div class="sub-menu-2" id="sub-menu-2" >
               <ul>
                  <li><i class='fa-solid fa-minus' id='an_right' ></i><a href="drug.php" target='iframe' onclick='hideMenu()'>Drug Requist</a></li>
                  <li><i class='fa-solid fa-minus' id='an_right' ></i><a href="all_requist.php" target='iframe' onclick='hideMenu()'>All Requist</a></li>
               </ul>
            </div></li>
      </ul></div>
      </div>
      <div class="nav_right">
         <div class="nav_top">
            ...
            <div class="nav_top_right">
               ...
               <a onclick="profile_left()" style="color: white;"><?php echo $row['Fname']; echo " "; echo $row['Lname']; ?><i class='fa-solid fa-angle-right' id="profile_right"></i></a>
