    ...
    <div class="r1">
        ...
        <div class="c1">
            <ul>
                ...
                <li><a href="new_patient.php" target="iframe"> New Patient</a></li>
                <li><a href="patient.php" target="iframe"> Patient Info</a></li>
                <li><a> Drug</a><div class="sub-menu-2">
                    <ul>
                       <li><a  href="drug.php" target="iframe" onclick="hideMenu()">New Drug</a></li>
                       <li><a href="drug_name.php" target="iframe" onclick="hideMenu()">Add Drug Name</a></li>
                    </ul><hr>
                 </div></li>
