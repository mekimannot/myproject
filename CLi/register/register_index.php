   ...
   <div class="index_box"  >
      <div class="nav_left" id="index_box" style="">
         ...
         <ul>
            ...
            <li><i class='fa-solid fa-bed' id="an_right"></i><a href="add_patient.php" target="iframe" onclick="hideMenu()">Add Patient</a></li>
         <li><i class='fa-solid fa-book' id="an_right"></i><a href="student_info.php" target="iframe" onclick="hideMenu()">Student Information</a></li>
