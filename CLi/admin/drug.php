<?php
  ...
  if(isset($_POST['submit'])){
    ...
    if($insert){
        ...
        echo "<script type='text/javascript'>document.location='drug.php';</script>";
    }else{
  ...
  if(isset($_GET['id'])){
    $id=$_GET['id'];
    $delete=mysqli_query($conn,"delete from drug where ID='$id'");
    if($delete){
        ...
        <div class="dep3">
            ...
            <form action="" method="post">
                ...
                <div class="two">
                    ...
                    <input type="text" name="dname" class="in">
                </div>
                <div class="two">
                    <label for="">Drug short Name</label>
                    <input type="text" name="dsname" class="in">
                </div>
            </div>
               ...
               if($count>0){
                while($row=mysqli_fetch_assoc($select)){
                   ...
                   <tr>
                    ...
                    <td>".$row['dname']."</td>
                    <td>".$row['dsname']."</td>
                    <td><a href='drug.php?id=".$row['ID']."'   ><i class='fa-solid fa-trash' id='dtrash' title='delete'></i></a></td>
                </tr>
                    ";
                    $rn++;
                }
