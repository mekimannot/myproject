...
<?php
  ...
  if(isset($_POST['s1'])){
    ...
    $update=mysqli_query($conn,"update patient set status='$status',Description='$description' where ID='$user_id'");
    if($update){
...
<body>
    ...
    <div class="dep2">
        <div class="dep3">
            ...
            <input type="submit" name="s1" value="submit" class="sub" style="margin-top: 10px; margin-bottom: 10px;">
